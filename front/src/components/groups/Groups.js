...
import "./Groups.css"
import { Card, CardText, Col, Row, Button, Modal, ModalBody, ModalFooter } from 'reactstrap'
...
class Groups extends React.Component {
  ...
  render() {
    return (
      <div class="lists">
        <Button color="primary" onClick={this.toggleModalDemo}>Adauga grup</Button>
        <Modal isOpen={this.state.modalDemo} toggle={this.toggleModalDemo}>
          ...
          <ModalFooter>
            ...
            <Button color="primary" onmessage={this.addGroup}>
            Save changes
            </Button>
          </ModalFooter>
        </Modal>
